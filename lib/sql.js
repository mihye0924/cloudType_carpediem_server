export const sql = {
  ...
  listUpdate: `UPDATE list SET list_content = ? WHERE list_no = ? AND account_name = ?;`,
  listDelete: `DELETE FROM list WHERE account_name = ? AND list_no = ?;`, 
  listLikes: `INSERT INTO likes (account_name, list_no) VALUES (?, ?);`,
  listLikesRemove: `DELETE FROM likes WHERE account_name = ? AND list_no = ?;`,
  listLkiesData : `SELECT * FROM likes WHERE account_name = ?;`
}
